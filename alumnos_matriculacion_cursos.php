...
<div id="top" class="jumbotron text-center">
  	<br><h2><b>Matriculaci&oacute;n y Desmatriculaci&oacute;n de cursos</b></h2>      
</div>
<div class="container">
			<div class="row">
	...
	<div class="row">
		<div class="col-md-12 text-center">
			<h4>Primeros pasos explicacion de como estos son los tutoriales para emarking que si bien el todo conforma emarking cada uno de estos cubre un area independiente.</h4>
		</div>
	</div>
		<hr class="featurette-divider"/>
	<div class="row">
		...
		<div class="container">
  			<div class="panel-group" id="collapsible_Matricular">
    			<div class="panel">
      				<div class="panel">
        				<h4 class="panel">
          					<span class="glyphicon glyphicon-play"></span><a data-toggle="collapse" data-parent="#collapsible_Matricular" data-target="#Matricularse1" href="#Matricularse"> Buscar Curso</a>
        				</h4>
      				</div>
    			...
    			<div class="panel">
      				<div class="panel">
        				<h4 class="panel">
          					<span class="glyphicon glyphicon-play"></span><a data-toggle="collapse" data-parent="#collapsible_Matricular" data-target="#Matricular2" href="#Matricularse"> Matricularse</a>
        				</h4>
      				</div>
		...
		<div class="container">
  			<div class="panel-group" id="collapsible_Desmatricularse">
    			<div class="panel">
      				<div class="panel">
        				<h4 class="panel">
          					<span class="glyphicon glyphicon-play"></span><a data-toggle="collapse" data-parent="#collapsible_Desmatricularse" data-target="#Desmatricularse_1" href="#Desmatricularse"> Seleccion del curso</a>
        				</h4>
      				</div>
      				<div id="Desmatricularse_1" class="panel-collapse collapse in">
        				<div class="panel-body">
        					<div class="row">
        						<div class="col-md-7">
    			...
    			<div class="panel">
      				<div class="panel">
        				<h4 class="panel">
          					<span class="glyphicon glyphicon-play"></span><a data-toggle="collapse" data-parent="#collapsible_Desmatricularse" data-target="#Desmatricularse_2" href="#Desmatricularse"> Darse de bajar</a>
        				</h4>
      				</div>
      				<div id="Desmatricularse_2" class="panel-collapse collapse">
        				<div class="panel-body">
            				<div class="row">
        						<div class="col-md-7">
