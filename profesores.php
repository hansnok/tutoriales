...
<div class="jumbotron text-center">
	<h1><span class="glyphicon glyphicon-blackboard"></span> Profesores</h1> 
  	<p>Los profesores de un curso pueden crear diferentes actividades por lo tanto es necesario estar informado</p>
</div>
<div class="container">
			<div class="row">
				<div class="col-sm-6">
...
<!-- Videos recomendados del area de profesores , en caso de ser modificados el tamaño debe permanecer en 250  -->

<div class="container">
    <div class="row">
		 <div class="row text-center">
		<div class="col-md-4">
			 <br><iframe width="300" height="250" src="https://www.youtube.com/embed/HqA-3jMJoyI" frameborder="0" allowfullscreen></iframe>
		</div>
		<div class="col-md-4">
			 <br><iframe width="300" height="250" src="https://www.youtube.com/embed/xPKh23Wj-H0" frameborder="0" allowfullscreen></iframe>
		</div>
		<div class="col-md-4">
			 <br><iframe width="300" height="250" src="https://www.youtube.com/embed/yHUkeo8-YZM" frameborder="0" allowfullscreen></iframe>
		</div>
	</div>
	</div>
</div>
