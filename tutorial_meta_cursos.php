		...
		<div class="container">
  			<div class="panel-group" id="collapsible_Metacurso">
    			<div class="panel">
      				<div class="panel">
        				<h4 class="panel">
          					<span class="glyphicon glyphicon-play"></span><a data-toggle="collapse" data-parent="#collapsible_Metacurso" data-target="#Metacurso_1" href="#Metacurso"> Entrar a todos los cursos</a>
        				</h4>
      				</div>
      				<div id="Metacurso_1" class="panel-collapse collapse in">
    			...
    			<div class="panel">
      				<div class="panel">
        				<h4 class="panel">
          					<span class="glyphicon glyphicon-play"></span><a data-toggle="collapse" data-parent="#collapsible_Metacurso" data-target="#Correccion_2" href="#Correccion"> Seleccion de variables</a>
        				</h4>
      				</div>
    			...
    			<div class="panel">
      				<div class="panel">
        				<h4 class="panel">
          					<span class="glyphicon glyphicon-play"></span><a data-toggle="collapse" data-parent="#collapsible_Metacurso" data-target="#Correccion_3" href="#Correccion"> Creacion del metacurso</a>
        				</h4>
      				</div>
      				<div id="Correccion_3" class="panel-collapse collapse">
        				<div class="panel-body">
            				<div class="row">
								<div class="col-md-7">
