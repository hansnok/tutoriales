			 ...
			 <div class="container">
  				<div class="panel-group" id="collapsible_Matricular">
    				<div class="panel">
      					<div class="panel">
        					<h4 class="panel">
          						<span class="glyphicon glyphicon-play"></span><a data-toggle="collapse" data-parent="#collapsible_Creacion" data-target="#Matricular1" href="#Matricular"> Paso 1: Entrar a administracion del curso</a>
        					</h4>
      					</div>
      					<div id="Matricular1" class="panel-collapse collapse in">
    				...
    				<div class="panel">
      					<div class="panel">
        					<h4 class="panel">
          						<span class="glyphicon glyphicon-play"></span><a data-toggle="collapse" data-parent="#collapsible_Matricular" data-target="#Matricular2" href="#Matricular"> Paso 2: Seleccionar usuario y rol </a>
        					</h4>
      					</div>
    				...
    				<div class="panel">
      					<div class="panel">
        					<h4 class="panel">
          						<span class="glyphicon glyphicon-play"></span><a data-toggle="collapse" data-parent="#collapsible_Matricular" data-target="#Matricular3" href="#Matricular"> Paso 3: Matricular Usuario</a>
        					</h4>
      					</div>
      					<div id="Matricular3" class="panel-collapse collapse">
        					<div class="panel-body">
								<div class="row">
									<div class="col-md-7">
