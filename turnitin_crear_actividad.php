		...
		<div class="container">
  			<div class="panel-group" id="collapsible_Crear">
    			<div class="panel">
      				<div class="panel">
        				<h4 class="panel">
          					<span class="glyphicon glyphicon-play"></span><a data-toggle="collapse" data-parent="#collapsible_Crear" data-target="#Crear1" href="#Crear"> Paso 1: Crear actividad turnitin</a>
        				</h4>
      				</div>
      				<div id="Crear1" class="panel-collapse collapse in">
    			...
    			<div class="panel">
      				<div class="panel">
        				<h4 class="panel">
          					<span class="glyphicon glyphicon-play"></span><a data-toggle="collapse" data-parent="#collapsible_Crear" data-target="#Crear2" href="#Crear"> Paso 2: Configuracion</a>
        				</h4>
      				</div>
    			...
    			<div class="panel">
      				<div class="panel">
        				<h4 class="panel">
          					<span class="glyphicon glyphicon-facetime-video"></span><a data-toggle="collapse" data-parent="#collapsible_Crear" data-target="#Crear3" href="#Crear"> Video: Crear actividad turnitin</a>
        				</h4>
      				</div>
      				<div id="Crear3" class="panel-collapse collapse">
        				<div class="panel-body">
            				<iframe width="600" height="600" src="https://www.youtube.com/embed/Rr8h2Lx8X9A" frameborder="0" allowfullscreen></iframe>
        				</div>
      				</div>
    			</div>
  			</div> 
